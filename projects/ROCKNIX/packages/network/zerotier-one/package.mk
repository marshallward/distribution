...
#
#	# libnatpmp
#	make -C ext/libnatpmp CC=${CC}
#
#    # Pretend we are armv7 to avoid unsupported v8 instructions
#	export CPPFLAGS="${CPPFLAGS} -Iext/libnatpmp"
#    make -f make-linux.mk ZT_SSO_SUPPORTED=0 CC_MACH=armv7 LDFLAGS="${LDFLAGS} -Lext/libnatpmp" one
#}
#
#makeinstall_target() {
